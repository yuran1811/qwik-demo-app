...
export default component$(() => {
  return (
    <div class="flex max-w-md flex-col gap-2 rounded-md bg-gray-900 p-6 text-gray-100 shadow-md dark:bg-gray-50 dark:text-gray-800">
      ...
      <p class="flex-1 text-gray-400 dark:text-gray-600">
      ...
      <div class="mt-6 flex flex-col justify-end gap-3 sm:flex-row">
        <button class="rounded-sm px-6 py-2">No</button>
        <button class="rounded-sm bg-violet-400 px-6 py-2 text-gray-900 shadow-sm dark:bg-violet-600 dark:text-gray-50">
          Yes
        </button>
      </div>
    </div>
